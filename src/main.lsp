(defun c:AddManhole ()
  ...
  (if pt
    (progn
      ...
      ;; Suppress prompts and add a hatch
      (setvar "HPASSOC" 1) ;; Ensure the hatch is associative
      (command "_.HATCH" "P" "SOLID" "") ;; Create solid hatch automatically
      ...
      (if manhole-tag
        (progn
          ...
          (setq text-location (polar pt 0.0 1.5)) ;; Offset text for visibility
